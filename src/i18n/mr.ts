...
export const mr: Record<keyof typeof en, string> = {
  ...
  severalPaid: 'दोघांनी किंवा अधिक जणांनी दिले',
  onePaid: 'एकानेच दिले',
  payersOverError: 'दिलेल्या रकमांची बेरीज एकूण रकमेपेक्षा {amount} ने जास्त आहे.',
  payersShortError: 'दिलेल्या रकमेतील {amount} कोणाच्या नावावर नाहीत.',
  ...
  adding: 'जोडत आहे…',
  photosHint: 'फोटो जतन करण्याआधी लहान केले जातात.',
  photosStored: '{photos} · लहान केल्यावर {size}.',
  photos: '{count} फोटो',
  ...
  offlineBanner:
    'नेटवर्क नाही — जतन या फोनवर झाले आहे, नेटवर्क आल्यावर ते तुमच्या खात्यात जाईल.',
  cloudOfflineNow: 'नेटवर्क नाही · या फोनवर जतन',
  cloudSyncOffBodyOffline:
    'सध्या नेटवर्क नाही. तुम्ही भरलेले या फोनवर जतन होतेच; नंतर साइन इन केल्यावर ते खात्यातही जाईल.',
